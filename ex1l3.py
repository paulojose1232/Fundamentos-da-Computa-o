...
while idade >= 0:
    ...
    if (idade < 30 and idade > 0):
        ...
        if (sexo == "M" or sexo == "m"):
            ...
            print("Salario antigo M", salarioAntigoM, "salario atual M", salarioAtualM, "Salario Masculino",
                  salarioMasculino)
            ...
            print("Salario antigo F", salarioAntigoF, "salario atual F", salarioAtualF, "salarioFeminino",
                  salarioFeminino)
        ...
        continue
print("A media salarial masculina é", mediaSalarialMasculina, "A media salarial feminina é", mediaSalarialFeminina)
